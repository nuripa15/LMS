...
<html lang="en">
<head>
	<title>Selamat Datang LMS Sekolah Ponpes Palaan</title>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1">
<!--===============================================================================================-->	
	<link rel="shortcut icon" type="image/png" href="vendor/images/logo.png"/>
<!--===============================================================================================-->
...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('vendor/login/images/02.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
			 <center><img src="vendor/images/ybp.jpeg" alt="" height="70" width="70"></center>
       <br>
				<form method="post" action="" class="login100-form validate-form">
					...
					<div class="text-right p-t-8 p-b-31">
						<a href="https://wa.me/6283820241443">
							Forgot password?
						</a>
					</div>
  ...
  if ($level =='1') {
      $sql = mysqli_query($con,"SELECT * FROM tb_guru WHERE nama_guru='$email' AND password='$pass' AND status='Y' ") or die(mysqli_error($con)) ;
    ...
    $sql = mysqli_query($con,"SELECT * FROM tb_siswa WHERE nama_siswa='$email' AND password='$pass' AND aktif='Y' ") or die(mysqli_error($con)) ;
      $data = mysqli_fetch_array($sql);
      $id = $data [0];
      $cek = mysqli_num_rows($sql);
