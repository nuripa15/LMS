    ...
    <header id="header-wrap">
      ...
      <div id="roof" class="hidden-xs">
          <div class="container">
              <!-- Wellcome Starts -->
              <div class="pull-left">
                <i class="fa fa-home" aria-hidden="true"></i> SEKOLAH PONPES PALAHAN
              </div>
              <!-- Wellcome End -->

              <!-- Quick Contacts Starts -->
              <div class="quick-contacts pull-right">
                  <span><i class="fa fa-phone"></i> (0838) 20241443</span>
                  <span><i class="fa fa-envelope"></i><a href="#">ahmadnuripa.rf.gd</a></span>
...
?>
    <div class="page-header" style="background: url(assets/img/tampilan.JPG);height: 270px;">
      <div class="container">
        <div class="row">         
          <div class="col-md-12">
          ...
          <div class="row">
            <div class="col-md-6  col-sm-6">
              <p class="copyright-text">
                © <a rel="nofollow" href=""><b>e-Guru</b> </a> 2022 - Ponpes Palahan
              </p>
            </div>
            <div class="col-md-6  col-sm-6">                
